      ...
      return (
        <div className="min-h-screen bg-ink flex flex-col items-center justify-center p-6">
          <div className="bg-surface border border-line rounded-2xl p-8 max-w-md w-full text-center">
            ...
            <h2 className="text-bright text-lg font-semibold mb-2">页面加载异常</h2>
            ...
            <button
              ...
              className="px-6 py-2.5 bg-primary-500 hover:bg-primary-600 text-on-brand text-sm font-medium rounded-xl transition-colors"
            >
              返回首页
            </button>
          </div>
