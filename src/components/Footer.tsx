...
export default function Footer() {
  ...
  return (
    <footer className="bg-ink-soft border-t border-line py-16 px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-10 sm:mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <a
              ...
              className="inline-flex items-center justify-center w-10 h-10 bg-raised border border-edge hover:border-ghost text-faint hover:text-bright transition-all duration-200"
            >
